...
dbWriteTable(con_fastapi, "listening", history[1:750000, ])


dbDisconnect(con_fastapi)

#generate sqlite database for fastapi
con_flask <- dbConnect(RSQLite::SQLite(), dbname = "../../apistoscrape.db")
...
dbWriteTable(con_flask, "listening", history[1:175000, ], field.types = c(date = "TEXT"))
